...
instruction
	...
	| return TK_SEMICOLON
	| break TK_SEMICOLON
	| scoped_instruction TK_SEMICOLON
	| scoped_instruction
	;
...
if_else
	: if TK_KEYWORD_ELSE scope
	;

if
	: TK_KEYWORD_IF TK_LEFT_PAREN expression TK_RIGHT_PAREN scope
	;

for
	: TK_KEYWORD_FOR TK_LEFT_PAREN variable_assignment TK_SEMICOLON expression TK_SEMICOLON variable_assignment TK_RIGHT_PAREN scope
	;

while
	: TK_KEYWORD_WHILE TK_LEFT_PAREN expression TK_RIGHT_PAREN scope
	;
