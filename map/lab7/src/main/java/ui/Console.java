...
public class Console {
    ...
    public Console(CommonService service) {
        ...
        mainEntries = List.of(
                new ConsoleMenuEntry("1", "Students", () -> runEntries(studentEntries)),
                new ConsoleMenuEntry("2", "Assignments", () -> runEntries(assignmentEntries)),
                new ConsoleMenuEntry("3", "Grades", () -> runEntries(gradeEntries)),
                new ConsoleMenuEntry("4", "Filters", () -> runEntries(filterEntries)),
    ...
    private void updateStudent() throws CommonServiceException, ValidationException {
        ...
        Student student = service.updateStudent(id, firstName, lastName, email, group, professorName, null);
